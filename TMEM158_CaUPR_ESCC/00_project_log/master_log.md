...
- 2026-06-19 latest: Added AlphaFold/UniProt topology context for TMEM158. Global pLDDT 56.66; TM1 supported, TM2 low-confidence; no interaction/localization proof.
...
- 2026-06-19 latest: Generated Scientific Reports local upload dry-run bundle, manifest, QC, checksums and ZIP archive. Machine bundle clearance: `pass`; final upload remains human-gated.
<!-- 2026-06-19 structural follow-up prioritization targeted layer -->
- 2026-06-19 latest: Added targeted structural follow-up prioritization without full rerun. Top candidate `POSTN->ITGA5`; ranked LR pairs=82; TAC_high-higher FDR pairs=12; high-priority pairs=11; direct interaction claim not made; machine structural follow-up clearance=`pass`. Refreshed repository release, final gap audit and Scientific Reports local bundle only.

<!-- 2026-06-19 lr compartment expression audit targeted layer -->
- 2026-06-19 latest: Added targeted LR compartment-expression feasibility audit without full rerun. Audited top structural pairs=20; expected compartment-pattern pairs=11; expression-boundary pairs=9; top pair remains `POSTN->ITGA5`; direct communication claim not made; machine LR compartment-expression clearance=`pass`. Refreshed repository release, final gap audit and Scientific Reports local bundle only.

<!-- 2026-06-19 reviewer risk response pack -->
- 2026-06-19 latest: Generated reviewer-risk stress-test matrix, pre-emptive response pack and editorial triage audit. Machine reviewer-risk clearance: `pass`.
<!-- 2026-06-19 manuscript numeric consistency audit -->
- 2026-06-19 latest: Added manuscript numeric consistency audit. Clearance: `pass`.

<!-- 2026-06-19 claim-boundary text audit -->

- 2026-06-19 latest: Added public-facing claim-boundary text audit and machine submission clearance audit. Current machine claim-boundary status: `pass`.
...
- 2026-06-19 latest: Added official Scientific Reports/Nature Portfolio policy audit and Reporting Summary working draft. Machine-auditable status: `pass`; human-gated submission rows remain explicit.
