...
Esophageal squamous cell carcinoma (ESCC) remains biologically heterogeneous, and transcriptional states linking calcium homeostasis, unfolded protein response (UPR) branch activity and the stromal ecosystem are incompletely defined. We performed a pure public-data, hypothesis-generating analysis to identify and characterize upstream candidates associated with a Ca2/UPR stress ecology in ESCC. After an axis-first regulator screen, TMEM158 emerged as a lead computational candidate rather than a pre-specified single-gene biomarker. Across public ESCC cohorts, TMEM158 showed tumour-elevated expression in TCGA, GSE20347 and GSE26886, with a non-significant tumour-normal shift in GSE45670. In TCGA tumours, TMEM158 correlated with Ca2-axis, PERK-bias and CAF scores, whereas external datasets showed stronger and more reproducible CAF-coupled ecology than uniform Ca2 activation. We therefore defined a rule-based TAC_high state, combining high TMEM158, Ca2/PERK-core and CAF scores. TAC_high was observed in all four bulk cohorts and was associated with replicated proteostasis-score and cell-survival-score elevation, but not with significant clinical overall survival differences. Data-driven transcriptome meta-analysis showed that TAC_high is dominated by an ECM/CAF/epithelial-mesenchymal-transition programme, with top genes including POSTN, COL6A3, COL1A2, TMEM158 and FAP. A core-by-CAF interaction model did not yield FDR-significant single genes, but showed pathway-level enrichment for translation, oxidative phosphorylation, MYC targets, N-linked glycosylation and SRP-dependent cotranslational membrane targeting. To stress-test stromal confounding, CAF-adjusted TAC_high transcriptome models were completed in four cohorts and retained 1,944 positive meta-FDR<0.10 genes, led by CHST7, TMEM158, MAFG, ABCC1 and NFE2L2, with MYC targets, oxidative phosphorylation, KEAP1/NFE2L2, chemical-stress and translation pathways remaining prominent after adjustment; custom CAF/ECM, ER-proteostasis and drug-efflux sets were no longer FDR-positive as custom modules. In the independent 179-pair GSE53625 clinical cohort, targeted probe-sequence reannotation recovered 64 of 67 TMEM158/TAC target genes; TMEM158 was tumour-elevated (paired delta=0.466, FDR=1.05e-5), ECM-integrin and residual-stress scores were tumour-elevated, and TAC_high-like tumours showed higher ECM-integrin bridge and residual-stress scores, while TMEM158, full TAC score and TAC_high status remained non-significant for overall survival. Independent GSE160269 raw single-cell compartment analysis localized TAC_high meta-signatures most strongly to fibroblast/CAF pseudo-bulk profiles, including a TAC_high-positive top50 signature that was higher in TAC_high tumours within fibroblasts (FDR=0.003). Candidate CAF-to-epithelial ligand-receptor bridge analysis further nominated POSTN-integrin, collagen-integrin, FN1-integrin and MIF-CXCR4 pairings, with ECM-integrin and MIF/SPP1 axes higher in TAC_high. A second treatment-context single-cell dataset, GSE221561, independently localized the TAC meta-ECM programme to fibroblast pseudo-bulk profiles (fibroblast-versus-epithelial paired delta=3.149, P=0.031), although matched bridge correlations remained descriptive because only six tumour libraries had paired epithelial and fibroblast profiles after partial raw-library recovery. Public source data from an ESCC spatial whole-transcriptome progression study further supported a fibroblast-rich progression context, with DSP fibroblast abundance and alpha-SMA fibroblast IF increasing from normal epithelium to ESCC, while the restricted full spatial matrix prevented direct TAC_high rescoring. Single-cell pseudo-bulk immune analysis mapped TAC_high but did not support robust T-cell exhaustion, Treg or suppressive-myeloid enrichment. cBioPortal and public protein-atlas analyses further suggested that TAC_high is not trivially explained by TMEM158 mutation, amplification or promoter methylation, and that TMEM158 is a reviewed transmembrane-protein candidate with public antibody context but without direct ESCC protein or ER-localization validation. These data support a TMEM158-associated Ca2/UPR-CAF stress ecology state as a public-data biological discovery candidate in ESCC, while preserving an explicit boundary between association and causality.

## Introduction

ESCC progression is shaped by tumour-cell stress adaptation and by reciprocal interactions with the tumour microenvironment. Calcium homeostasis and endoplasmic-reticulum stress are central to proteostasis, apoptosis and therapy-pressure responses. The UPR is not a single linear pathway; PERK, IRE1 and ATF6 branches can diverge according to stress duration, cellular lineage and microenvironmental context. This branch-level complexity creates an opportunity for public multi-cohort analyses that move beyond generic ER-stress signatures and instead define reproducible tumour states.

Our previous SMIM14-focused public-data analysis did not support SMIM14 as a strong core driver, prognostic marker or treatment-resistance determinant. We therefore rebuilt the project around a Ca2/UPR axis-first strategy. Candidate prioritization selected TMEM158 as the lead computational upstream candidate, with CORO1C and several transporter/proteostasis-related genes retained as secondary program members. TMEM158 is a transmembrane protein with limited ESCC-specific Ca2/UPR literature overlap, making it suitable as an entry point for an axis-centred, public-data discovery study.
...
We defined TAC_high as the rule-based state in which a sample was high for the TMEM158-Ca2/PERK core and high for CAF score within its cohort. This definition was chosen because it is interpretable, tied to the biological model and reproducible across cohorts. The TAC_high state was present in all four bulk cohorts: GSE20347 (n=5), GSE26886 (n=4), GSE45670 (n=8) and TCGA (n=58).
...
We further tested whether the TAC_high signal exceeded random state assignment within each cohort. Cohort-preserving permutation analysis showed the strongest specificity for drug-efflux transcriptional readout (weighted median delta=0.543, empirical two-sided P=0.00350, empirical FDR=0.0105). Proteostasis showed a positive but not FDR-confirmed specificity trend (delta=0.349, empirical two-sided P=0.0815, empirical FDR=0.122), whereas survival score was not random-label specific (delta=0.147, empirical two-sided P=0.434). Component contrasts supported TAC_high above Axis_only for proteostasis and above TAC_low for survival and drug-efflux readouts. These data refine the biological interpretation toward a transport/efflux-proteostasis adaptation state rather than a validated clinical-survival subtype.
...
To reduce dependence on pre-specified score panels, we tested TAC_high using whole-transcriptome limma models within each bulk cohort followed by signed Stouffer meta-analysis. TAC_high versus all other states was completed in four cohorts and produced a strong data-driven stromal programme. The leading meta genes included POSTN, COL6A3, COL1A2, TMEM158, CHST7, COL3A1, FAP, SULF1, COL1A1 and COL6A2. Gene-set enrichment was dominated by HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION, extracellular-matrix organization, collagen formation, ECM proteoglycans and syndecan interactions.
...
**Main Figure 5. Single-cell fibroblast localization and candidate CAF-to-epithelial bridge.** Raw single-cell pseudo-bulk analysis localizes TAC_high meta-signatures to fibroblast/CAF compartments and nominates ECM-integrin and MIF/CXCR4 candidate bridges.
...
2. Barrett, T. et al. NCBI GEO: archive for functional genomics data sets--update. *Nucleic Acids Research* 41, D991-D995 (2013). doi:10.1093/nar/gks1193.
3. Cerami, E. et al. The cBio cancer genomics portal: an open platform for exploring multidimensional cancer genomics data. *Cancer Discovery* 2, 401-404 (2012). doi:10.1158/2159-8290.CD-12-0095.
4. Gao, J. et al. Integrative analysis of complex cancer genomics and clinical profiles using the cBioPortal. *Science Signaling* 6, pl1 (2013). doi:10.1126/scisignal.2004088.
5. UniProt Consortium. UniProt: the Universal Protein Knowledgebase in 2023. *Nucleic Acids Research* 51, D523-D531 (2023). doi:10.1093/nar/gkac1052.
6. Binns, D. et al. QuickGO: a web-based tool for Gene Ontology searching. *Bioinformatics* 25, 3045-3046 (2009). doi:10.1093/bioinformatics/btp536.
7. Uhlen, M. et al. Tissue-based map of the human proteome. *Science* 347, 1260419 (2015). doi:10.1126/science.1260419.
8. Johnson, W. E., Li, C. & Rabinovic, A. Adjusting batch effects in microarray expression data using empirical Bayes methods. *Biostatistics* 8, 118-127 (2007). doi:10.1093/biostatistics/kxj037.
9. Subramanian, A. et al. Gene set enrichment analysis: a knowledge-based approach for interpreting genome-wide expression profiles. *Proceedings of the National Academy of Sciences of the United States of America* 102, 15545-15550 (2005). doi:10.1073/pnas.0506580102.
10. Liberzon, A. et al. The Molecular Signatures Database (MSigDB) hallmark gene set collection. *Cell Systems* 1, 417-425 (2015). doi:10.1016/j.cels.2015.12.004.
11. Ritchie, M. E. et al. limma powers differential expression analyses for RNA-sequencing and microarray studies. *Nucleic Acids Research* 43, e47 (2015). doi:10.1093/nar/gkv007.
...
13. Wang, M. & Kaufman, R. J. The impact of the endoplasmic reticulum protein-folding environment on cancer development. *Nature Reviews Cancer* 14, 581-597 (2014). doi:10.1038/nrc3800.
14. Cubillos-Ruiz, J. R., Bettigole, S. E. & Glimcher, L. H. Tumorigenic and immunosuppressive effects of endoplasmic reticulum stress in cancer. *Cell* 168, 692-706 (2017). doi:10.1016/j.cell.2016.12.004.
15. Hetz, C., Chevet, E. & Oakes, S. A. Proteostasis control by the unfolded protein response. *Nature Cell Biology* 17, 829-838 (2015). doi:10.1038/ncb3184.
16. Kalluri, R. The biology and function of fibroblasts in cancer. *Nature Reviews Cancer* 16, 582-598 (2016). doi:10.1038/nrc.2016.73.
17. Barradas, M. et al. Identification of a candidate tumor-suppressor gene specifically activated during Ras-induced senescence. *Experimental Cell Research* 273, 127-137 (2002). doi:10.1006/excr.2001.5434.
18. Fu, Y. et al. TMEM158 promotes pancreatic cancer aggressiveness by activation of TGFbeta1 and PI3K/AKT signaling pathway. *Journal of Cellular Physiology* 235, 2761-2775 (2020). doi:10.1002/jcp.29181.
19. Li, J. et al. TMEM158 promotes the proliferation and migration of glioma cells via STAT3 signaling in glioblastomas. *Cancer Gene Therapy* 29, 822-833 (2022). doi:10.1038/s41417-021-00414-5.
20. Zhang, X. et al. Dissecting esophageal squamous-cell carcinoma ecosystem by single-cell transcriptomic analysis. *Nature Communications* 12, 5291 (2021). doi:10.1038/s41467-021-25539-x.
...
22. Li, L. et al. Integrative proteogenomic characterization of early esophageal cancer. *Nature Communications* 14, 1666 (2023). doi:10.1038/s41467-023-37440-w.
23. Jiang, G. et al. The integrated molecular and histological analysis defines subtypes of esophageal squamous cell carcinoma. *Nature Communications* 15, 8990 (2024). doi:10.1038/s41467-024-53164-x.
24. Yang, Z. et al. Single-cell sequencing reveals immune features of treatment response to neoadjuvant immunochemotherapy in esophageal squamous cell carcinoma. *Nature Communications* 15, 9103 (2024). doi:10.1038/s41467-024-52977-0.
